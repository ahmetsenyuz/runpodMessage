...
class ConsoleApp {
  ...
  async handleChoice(choice: string): Promise<boolean> {
    try {
      ...
      handleGlobalError(error, 'handleChoice');
    }
    return true;
  }
  ...
  async viewAllItems(): Promise<void> {
    try {
      ...
      handleGlobalError(error, 'viewAllItems');
    }
  }
  ...
  async addNewItem(): Promise<void> {
    try {
      ...
      handleGlobalError(error, 'addNewItem');
    }
  }
  ...
  async viewSpecificItem(): Promise<void> {
    try {
      ...
      handleGlobalError(error, 'viewSpecificItem');
    }
  }
  ...
  async updateItem(): Promise<void> {
    try {
      ...
      handleGlobalError(error, 'updateItem');
    }
  }
  ...
  async deleteItem(): Promise<void> {
    try {
      ...
      handleGlobalError(error, 'deleteItem');
    }
  }
  ...
  async markItemAsComplete(): Promise<void> {
    try {
      ...
      handleGlobalError(error, 'markItemAsComplete');
    }
  }
  ...
  async searchItems(): Promise<void> {
    try {
      // In a real implementation, we would prompt for search query
      ...
      handleGlobalError(error, 'searchItems');
    }
  }
